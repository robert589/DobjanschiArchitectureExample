 ...
 */
public class DistroGueProcessor {

    private String LOG = DistroGueProcessor.class.getSimpleName();
    ...
    public DistroGueProcessor(String email, Context context){
        this.email = email;
        this.context = context;
    }

    public Response retrieveUserRelation(){
        try{
